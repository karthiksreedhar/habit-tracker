...
async function generateCoach(email, { habits, journal, insights, widgetState = null, tz = null, force = false, forDate = null }) {
...
async function generateWeekly(email, { habits, journal, insights, goalsBlock = '', force = false, tz = null }) {
  const now = new Date();
