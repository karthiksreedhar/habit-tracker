...
//                    goalAssessment*, social, socialSnapshot*, constraints*,
//                    updatedAt }
...
const ENCRYPTED_USER_FIELDS = ['tokens', 'goals', 'goalAssessment', 'socialSnapshot', 'customWidgets', 'constraints'];
...
function counterFor(type, meta) {
  switch (type) {
    ...
    case 'goal_edit': return 'goals_edited';
